...
PYBIND11_MODULE(molsim, m)
{
  ...
  pybind11::class_<MonteCarlo>(m, "MonteCarlo")
      .def(pybind11::init<size_t, size_t, size_t, double, double, double, double, double, double, size_t, double,
           ...
           pybind11::arg("maxVolumeChange") = 1.0, pybind11::arg("sampleFrequency") = 100, pybind11::arg("sigma") = 1.0,
